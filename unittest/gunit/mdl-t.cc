...
extern "C" void mdl_test_error_handler_hook(uint err, const char *str, myf) {
...
class MDLTest : public ::testing::Test, public Test_MDL_context_owner {
 protected:
  ...
  static void SetUpTestCase() {
    ...
    error_handler_hook = mdl_test_error_handler_hook;
  }
...
class MDL_thread : public Thread, public Test_MDL_context_owner {
 public:
  ...
  void run() override;
  void enable_release_on_notify() {
    m_enable_release_on_notify = true;
    m_mdl_context.set_needs_thr_lock_abort(true);
  }
