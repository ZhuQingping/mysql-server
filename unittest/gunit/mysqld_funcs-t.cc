...
void switch_background_thread_drv(bool set_val);
void check_background_thread_drv(bool before);
...
TEST(MysqldFuncs, JemallocBgThread) {
  switch_background_thread_drv(true);
  check_background_thread_drv(true);
}
}  // namespace mysqld_funcs_unit_test
#endif /* HAVE_GETPWNAM */
