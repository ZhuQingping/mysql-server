...
@param[in]  vio  vio to shutdown
@param[in]  how  shutdown both sides or only shutdown one direction.
                 can be SHUT_RDWR, SHUT_WR or SHUT_RD.
...
/**
just shutdown connection, do not close socket
