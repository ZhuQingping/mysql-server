...
/**
disconnect connection and close pipe
...
/**
just distconnect pipe, do not close it
...
/**
close shared memory connection, and invalidate socket
...
/**
close shared memory connection, but keep socket valid
