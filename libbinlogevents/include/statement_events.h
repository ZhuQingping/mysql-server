...
/**
  ...
  <tr>
    <td>rds_recycle_bin_mode</td>
    <td>Q_RECYCLE_BIN_MODE</td>
    <td>2 byte integer</td>
    <td>Value of the config variable rds_recycle_bin_mode</td>
  </tr>
  </table>
 ...
 public:
   ...
   */
    ...
    */
    ...
    /*
      Replicate rds_recycle_bin_mode.
    */
    Q_RECYCLE_BIN_MODE = 192
  };
  const char *query;
  const char *db;
  const char *catalog;
