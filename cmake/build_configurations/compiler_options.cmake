...
IF(UNIX)  
  ...
  IF(MY_COMPILER_IS_GNU AND NOT WITH_VALGRIND)
    IF(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 10.0.0.0)
      # In GCC 10 -O2 has smaller inlining threshold => performance loss
      # CMAKE_C_FLAGS_RELWITHDEBINFO is "-O2 -g -DNDEBUG" by default,
      # CMAKE_CXX_FLAGS_RELWITHDEBINFO is "-O2 -g -DNDEBUG" by default,
      # overriding them to -O3
