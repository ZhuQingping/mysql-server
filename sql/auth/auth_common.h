...
/**
  ...
  server implementation, such as 'performance_schema', 'INFORMATION_SCHEMA',
  'mysql' and 'sys'.
*/
...
/**
  Extension of ACL_internal_schema_access for mysql db
*/
...
/**
  Extension of ACL_internal_schema_access for sys db
*/
class Sys_internal_schema_access : public ACL_internal_schema_access {
 public:
