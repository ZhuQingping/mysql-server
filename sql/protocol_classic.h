...
class Protocol_classic : public Protocol {
 private:
  ...
  ulong m_extended_client_capabilities;
  ...
  */
  ...
  void set_extended_client_capabilities(uint64_t client_capability) {
    m_extended_client_capabilities = client_capability;
  }

  uint64_t get_extended_client_capabilites() const {
    return m_extended_client_capabilities;
  }
