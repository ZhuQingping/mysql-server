...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM("DROP", DROP)},
    {SYM("DSTORE_DDL_COMMENT", DSTORE_DDL_COMMENT_SYM)},
    {SYM("DUAL", DUAL_SYM)},
    ...
    {SYM("PRODUCT_VERSION", PRODUCT_VERSION_SYM)},
    ...
    */
    ...
    {SYM_H("NO_OFFSET_PUSHDOWN", NO_OFFSET_PUSHDOWN_HINT)},
    {SYM_H("OFFSET_PUSHDOWN", OFFSET_PUSHDOWN_HINT)},
    {SYM_H("PRC_SUBQUERY", PRC_SUBQUERY_HINT)},
    {SYM_H("NO_PRC_SUBQUERY", NO_PRC_SUBQUERY_HINT)},
    {SYM_H("PRC_JOIN", PRC_JOIN_HINT)},
    {SYM_H("NO_PRC_JOIN", NO_PRC_JOIN_HINT)}};
