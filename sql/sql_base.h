...
/**
   add a param only_rmv_second_engine. if true, do not remove table definition
   cache And only second engine table. If false, remove all. default value is
   false.
*/
void tdc_remove_table(THD *thd, enum_tdc_remove_table_type remove_type,
                      const char *db, const char *table_name, bool has_lock,
                      bool only_rmv_second_engine = false);
...
Table_ref *find_table_in_local_list(Table_ref *table, const char *db_name,
                                    const char *table_name,
