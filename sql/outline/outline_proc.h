...
/**
  ...
  1) dbms_outln.show_outline, dbms_outln.preview_outline
     didn't require any privileges;
  2) dbms_outln.flush_outline, dbms_outln.add_index_outline,
     dbms_outln.add_optimizer_outline, dbms_outln.del_outline
     must use the user's administrative account: 'root'@'%'.
*/
...
class Sql_cmd_outline_admin_proc : public Sql_cmd_admin_proc {
 public:
  explicit Sql_cmd_outline_admin_proc(THD *thd, mem_root_deque<Item *> *list,
                                      const Proc *proc)
      : Sql_cmd_admin_proc(thd, list, proc) {
    set_priv_type(Priv_type::PRIV_NONE_ACL);
  }
...
*/
class Sql_cmd_optimizer_outline_proc_add : public Sql_cmd_outline_admin_proc {
 public:
  explicit Sql_cmd_optimizer_outline_proc_add(THD *thd,
                                              mem_root_deque<Item *> *list,
                                              const Proc *proc)
      : Sql_cmd_outline_admin_proc(thd, list, proc) {}
  /**
...
/**
  ...
  and the outline cache that take effect immediately.
*/
class Sql_cmd_index_outline_proc_add : public Sql_cmd_outline_admin_proc {
 public:
...
*/
class Sql_cmd_outline_proc_del : public Sql_cmd_outline_admin_proc {
 public:
...
*/
class Sql_cmd_outline_proc_flush : public Sql_cmd_outline_admin_proc {
 public:
 ...
 public:
  explicit Outline_proc_show(PSI_memory_key key) : Outline_proc_base(key) {
    ...
    Column_element elements[COLUMN_LAST] = {
        {MYSQL_TYPE_LONGLONG, STRING_WITH_LEN("ID"), 0},
        ...
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("SCOPE"), 64},
        {MYSQL_TYPE_LONGLONG, STRING_WITH_LEN("POS"), 0},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("HINT"), 1024},
        {MYSQL_TYPE_LONGLONG, STRING_WITH_LEN("HIT"), 0},
        {MYSQL_TYPE_LONGLONG, STRING_WITH_LEN("OVERFLOW"), 0},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("DIGEST_TEXT"), 2048}};
...
class Outline_proc_preview : public Outline_proc_base {
 ...
 public:
  explicit Outline_proc_preview(PSI_memory_key key) : Outline_proc_base(key) {
    ...
    Column_element elements[COLUMN_LAST] = {
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("SCHEMA"), 64},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("DIGEST"), 64},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("BLOCK_TYPE"), 64},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("BLOCK_NAME"), 64},
        {MYSQL_TYPE_LONGLONG, STRING_WITH_LEN("BLOCK"), 64},
        {MYSQL_TYPE_VARCHAR, STRING_WITH_LEN("HINT"), 2048}};
