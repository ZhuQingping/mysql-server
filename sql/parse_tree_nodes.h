...
typedef PT_index_option<LEX_CSTRING, &KEY_CREATE_INFO::dstore_ddl_comment>
    PT_index_dstore_ddl_comment;
...
typedef PT_traceable_create_table_option<
    TYPE_AND_REF(HA_CREATE_INFO::dstore_ddl_comment),
    HA_CREATE_USED_DSTORE_DDL_COMMENT>
    PT_create_dstore_ddl_comment;
