...
class SQL_I_List {
 public:
  ...
  using iterator = SQL_I_List_STL_Iterator<T>;
  iterator begin() { return iterator(first); }
  iterator end() { return iterator(nullptr); }
  using const_iterator = SQL_I_List_STL_Iterator<const T>;
...
/// Inspired by List_STL_Iterator, adapted to iterate over SQL_I_List
template <class T>
class SQL_I_List_STL_Iterator {
 public:
  explicit SQL_I_List_STL_Iterator(T *element) : m_current(element) {}

  // Iterator (required for InputIterator).
  T &operator*() const { return *static_cast<T *>(m_current); }

  SQL_I_List_STL_Iterator &operator++() {
  ...
  bool operator==(const SQL_I_List_STL_Iterator &other) const {
  ...
  SQL_I_List_STL_Iterator() {}

  // ForwardIterator.
  SQL_I_List_STL_Iterator operator++(int) {
    SQL_I_List_STL_Iterator copy = *this;
    m_current = m_current->next;
    return copy;
  }
