...
static PSI_thread_info all_recycle_threads[] = {
    {&key_thread_recycle_scheduler, "recycle_scheduler", "rec_sched",
...
void recycle_scheduler_init() {
  DBUG_ENTER("recycle_scheduler_init");
...
void recycle_scheduler_deinit() {
  DBUG_ENTER("recycle_scheduler_deinit");
...
bool recycle_scheduler_start(bool bootstrap) {
  ...
  if (rds_recycle_scheduler && !bootstrap)
