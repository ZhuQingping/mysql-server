...
class Sql_cmd_insert_values : public Sql_cmd_insert_base {
 ...
 private:
  /** If this command belongs to a bulk execution of a prepared statement;
  this is specific of INSERT|REPLACE VALUES, which is the only command which
  has an optimized bulk execution path. */
  Prepared_statement *bulk_prepared_stmt{nullptr};
};
