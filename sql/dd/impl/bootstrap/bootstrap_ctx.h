...
class DD_bootstrap_ctx {
 private:
  ...
  uint m_actual_taurus_extended_dd_version = 0;
 ...
 public:
  ...
  void set_actual_taurus_extended_dd_version(uint actual_hw_extended_dd_v) {
    m_actual_taurus_extended_dd_version = actual_hw_extended_dd_v;
  }

  uint get_actual_dd_version() const { return m_actual_dd_version; }

  uint get_actual_taurus_extended_dd_version() const {
    return m_actual_taurus_extended_dd_version;
  }
  ...
  inline bool taurus_dd_version_no_changed() const {
    return m_actual_taurus_extended_dd_version ==
           dd::TAURUS_EXTENDED_DD_VERSION;
  }

  inline bool is_taurus_dd_version_inc() const {
    return (m_actual_dd_version == dd::DD_VERSION) &&
           (m_actual_taurus_extended_dd_version <
            dd::TAURUS_EXTENDED_DD_VERSION);
  }
  ...
  bool is_restart() const {
    return !opt_initialize && (m_actual_dd_version == dd::DD_VERSION) &&
           ...
           taurus_dd_version_no_changed();
  }

  bool is_dd_upgrade() const {
    return !opt_initialize &&
           (m_actual_dd_version < dd::DD_VERSION || is_taurus_dd_version_inc());
  }
