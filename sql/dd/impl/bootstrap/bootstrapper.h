...
/**
  print data dictionary version to error log.

  @param dd_version                    data dictionary version.
  @param taurus_extended_dd_version    extended data dictionary version.

  @return       Federated data dictionary version.
*/
