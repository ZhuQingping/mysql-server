...
void System_tables::add_remaining_dd_tables() {
  ...
  */
  ...
  register_table("rds_comment", system);
  ...
  */
  ...
  register_table("ddl_info_replay_trace", system);

  register_table("dstore_table_stats", system);
  register_table("dstore_index_stats", system);
}
