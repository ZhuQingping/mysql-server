...
class Table_impl : public Abstract_table_impl, virtual public Table {
 ...
 public:
  ...
  virtual void drop_foreign() override;
 ...
 public:
  ...
  enum_partition_type subpartition_type() const override {
    return m_subpartition_type;
  }

  void set_subpartition_type(enum_partition_type subpartition_type) override {
 ...
 public:
  ...
  bool recycle_bin_drop_column(const String_type &name) override {
    return Abstract_table_impl::recycle_bin_drop_column(name);
  }
 ...
 private:
  ...
  enum_partition_type m_subpartition_type;
