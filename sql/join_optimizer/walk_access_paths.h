...
void WalkAccessPaths(AccessPathPtr path, JoinPtr join,
  ...
  switch (path->type) {
    ...
    case AccessPath::STREAM:
      if (!path->stream().query_block_boundary ||
          cross_query_blocks == WalkAccessPathPolicy::ENTIRE_TREE ||
