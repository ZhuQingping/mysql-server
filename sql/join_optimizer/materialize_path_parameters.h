...
struct MaterializePathParameters {
  ...
  */
  ...
  /// See similar member in MaterializeIterator
  Semijoin_mat_exec *sj_mat_exec{nullptr};
  /// See similar member in MaterializeIterator
  bool pq_can_share{false};
  /// Used for parallel query, save serial param
  MaterializePathParameters *saved_param{nullptr};
};
