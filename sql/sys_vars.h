...
*/
constexpr const unsigned long MAX_RDS_ADMIN_CONNECTIONS_DEFAULT{100};
/**
  Maximum number of connections for reserved users default value.
*/
constexpr const unsigned long MAX_RDS_RESERVED_CONNECTIONS_DEFAULT{3000};
/*
