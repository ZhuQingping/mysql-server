...
constexpr const uint64_t OPTIMIZER_SWITCH_DERIVED_CONDITION_PUSHDOWN{1ULL
                                                                     << 25};
constexpr const uint64_t OPTIMIZER_SWITCH_DSTORE_USE_HISTOGRAM_RANGE_ESTIMATION{
    1ULL << 26};
/**
...
constexpr const uint64_t OPTIMIZER_SWITCH_OFFSET_PUSHDOWN{1ULL << 28};
constexpr const uint64_t OPTIMIZER_SWITCH_NLJ_DISTINCT_OPTIMIZE{1ULL << 29};
...
constexpr const uint64_t OPTIMIZER_SWITCH_DSTORE_ENABLE_INDEXSCAN{1ULL << 32};
constexpr const uint64_t OPTIMIZER_SWITCH_AGGREGATE_PUSHDOWN{1ULL << 33};
constexpr const uint64_t OPTIMIZER_SWITCH_LAST{1ULL << 34};

/** Used for security hardening ONLY. */
constexpr const uint64_t RDS_SECURITY_HARDENING_USE_LOAD_FILE{1ULL << 0};
