...
class IteratorProfilerImpl final : public IteratorProfiler {
  ...
  */
  ...
  void SetFromRunningInfo(const IteratorTimingInfo &info) override {
    m_num_rows = info.m_num_rows;
    m_num_init_calls = info.m_num_init_calls;
    m_elapsed_first_row = info.m_time_spent_in_first_row;
    m_elapsed_other_rows = info.m_time_spent_in_other_rows;
  }

  void CopyToRunningInfo(IteratorTimingInfo &info) const override {
    info.m_num_rows = m_num_rows;
    info.m_num_init_calls = m_num_init_calls;
    info.m_time_spent_in_first_row = m_elapsed_first_row;
    info.m_time_spent_in_other_rows = m_elapsed_other_rows;
  }
...
class TimingIterator final : public RowIterator {
 public:
  ...
  int End() override { return m_iterator.End(); }
