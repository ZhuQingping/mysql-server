...
#endif
extern bool rds_purge_binary_logs_asynchronously;
extern bool opt_rds_permission_control;
extern bool opt_rds_processlist_control;
extern bool opt_rds_internal_schema_ddl_control;
extern bool opt_rds_internal_schema_dml_control;
extern bool opt_rds_allow_empty_users;
extern bool opt_rds_sync_comment;
...
extern const char *storage_engine_mode_names[];
...
extern const char *debug_info_prefix;
extern const char *node_id_ptr;
extern bool rds_load_data_infile_enable;
extern bool rds_disable_user_defined_functions;
extern ulonglong rds_security_hardening;
extern ulonglong kMaxChunks;
extern bool pq_master_enable;
extern bool hint_work_for_view;
...
#endif
extern bool opt_warn_sql_log_bin;
extern char *rds_reserved_users_ptr;
...
extern MYSQL_PLUGIN_IMPORT ulong max_rds_reserved_connections;
...
extern int32 rds_max_num_of_binary_logs_purged_per_time;
extern ulong rds_binlog_purge_thread_wait_timeout;
...
extern ulong rds_binlog_purge_thread_status;
...
extern ulong rds_conn_log_error_verbosity;
...
extern double rds_packet_size_factor;
...
extern bool rds_write_binlog_into_redo;
extern bool rds_binlog_concurrent_commit;
extern bool rds_binlog_dstore_consistent;
extern bool rds_dstore_enable_atomic_ddl;
extern uint32_t rds_dstore_ddl_max_concurrency;
extern uint32_t rds_dstore_ddl_throttle_timeout;
extern bool rds_dstore_write_ddl_info_into_redo;
extern bool rds_dstore_write_ddl_sql_into_redo;
extern bool rds_use_ddl_info_replay;
extern bool rds_dstore_support_binlog_check;
extern bool rds_binlog_enable_group_replication;
extern bool rds_binlog_skip_run_after_commit_hook;
extern bool rds_binlog_dstore_trace;
extern bool rds_warn_alter_table_add_auto_incre_column;

extern bool rds_binlog_lock_enable;

// The maximum WAL record size is 64512 bytes.
const int binlog_write_redo_buffer_size = 64512;
extern char *rds_dstore_missed_gtids_ptr;

extern char *opt_authentication_policy;
extern std::vector<std::string> authentication_policy_list;

extern bool dstore_use_histogram_auto_update;
...
extern bool opt_rds_restricted_dynamic_privileges_control;
extern char *rds_restricted_dynamic_privileges_list_ptr;
extern std::set<std::string> restricted_dynamic_privileges_set;

extern bool rds_imitate_mariadb_server;
extern bool rds_show_hidden_table;
extern bool rds_allow_skip_locked_now_wait;

extern ulong rds_physical_rpl_sender_packet_size;
extern ulong rds_physical_rpl_sender_wait_times;
extern ulong rds_physical_rpl_sender_sleep_us;

extern bool rds_local_backup_use_obs;
extern bool current_lb_use_obs;
extern char *rds_local_backup_obs_host;
extern char *rds_local_backup_obs_bucket;
extern char *rds_local_backup_obs_ak;
extern char *rds_local_backup_obs_sk;
extern uint32_t rds_local_backup_obs_uri_style;

extern uint32_t rds_lb_obs_buffer_size;
extern bool rds_lb_obs_enable_scc_decrypt;
extern uint32_t rds_lb_obs_max_connected_time;
extern bool rds_lb_obs_encryption;
extern char *rds_lb_obs_kms_key_id;

// SCC crypto component
extern char *rds_scc_conf;
extern bool rds_scc_initialized;
...
extern size_t vfd_max_open_files;
extern bool opt_rds_maintenance_operation_write_binlog;
...
extern PSI_rwlock_key key_rwlock_table_share_lock_m_histogram;
extern PSI_rwlock_key key_rwlock_LOCK_restricted_dynamic_privileges_list;
...
extern PSI_thread_key key_thread_purge_binlog;
...
extern PSI_stage_info stage_logging_oma;
...
extern PSI_stage_info stage_requesting_wallog_dump;
extern PSI_stage_info stage_waiting_for_source_to_send_wallog;
extern PSI_stage_info stage_write_source_wallog_to_file;
extern PSI_stage_info stage_rpl_wal_wait_flush;
...
extern mysql_mutex_t LOCK_purge_binlog;
...
extern mysql_cond_t COND_purge_binlog;
...
extern mysql_rwlock_t LOCK_restricted_dynamic_privileges_list;
...
extern bool rds_recycle_bin_binlog_session_variables;
/**
