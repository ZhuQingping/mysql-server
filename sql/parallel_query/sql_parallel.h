...
struct PQ_global_stats {
  ...
  std::atomic<uint64> orderby_execution_preflight_missing_exchange_heap_read{0};
  std::atomic<uint64> orderby_execution_preflight_missing_leader_materialization{0};
  std::atomic<uint64> orderby_execution_preflight_missing_rowid_tiebreak{0};
  std::atomic<uint64> orderby_execution_preflight_missing_default_ordered_read{0};
  std::atomic<uint64> orderby_execution_preflight_missing_error_diagnostics{0};
  ...
  std::atomic<uint64> orderby_sort_state_handoff_smoke_attempts{0};  ///< E5d-4c
  std::atomic<uint64> orderby_sort_state_handoff_smoke_success{0};  ///< E5d-4c
  std::atomic<uint64> orderby_sort_state_handoff_smoke_unsupported{0};  ///< E5d-4c
  ...
  std::atomic<uint64> saved_order_chain_flags_smoke_attempts{0};  ///< E5d-2b
  std::atomic<uint64> saved_order_chain_flags_smoke_success{0};  ///< E5d-2b
  std::atomic<uint64> saved_order_chain_flags_smoke_unsupported{0};  ///< E5d-2b
  ...
  std::atomic<uint64> parallel_scan_iterator_order_gather_selected{0};  ///< E3
  std::atomic<uint64> parallel_scan_iterator_order_gather_smoke_rows{0};  ///< E3
  std::atomic<uint64> parallel_scan_iterator_row_value_attempts{0};  ///< D6 hook
  std::atomic<uint64> parallel_scan_iterator_row_value_selected{0};  ///< D6 selected
  std::atomic<uint64> parallel_scan_iterator_row_value_rows{0};  ///< D6 rows
  ...
  std::atomic<uint64> worker_ref_ctx_cleanup_attempts{0};  ///< F6a-2
  ...
  std::atomic<uint64> worker_ref_carrier_attempts{0};  ///< F6e-4
  std::atomic<uint64> worker_ref_carrier_success{0};  ///< F6e-4
  std::atomic<uint64> worker_ref_carrier_rows{0};  ///< F6e-4
  std::atomic<uint64> worker_ref_carrier_finishes{0};  ///< F6e-4
  std::atomic<uint64> worker_ref_carrier_errors{0};  ///< F6e-4
  ...
  std::atomic<uint64> orderby_worker_handler_ref_attempts{0};  ///< E6a
  std::atomic<uint64> orderby_worker_handler_ref_success{0};  ///< E6a
  std::atomic<uint64> orderby_worker_handler_ref_unsupported{0};  ///< E6a
  std::atomic<uint64> orderby_worker_handler_ref_bytes{0};  ///< E6a
  std::atomic<uint64> orderby_worker_handler_ref_cmp_equal{0};  ///< E6a
  std::atomic<uint64> orderby_handler_ref_wire_attempts{0};  ///< E6b
  std::atomic<uint64> orderby_handler_ref_wire_success{0};  ///< E6b
  ...
  std::atomic<uint64> orderby_handler_ref_adapter_smoke_attempts{0};  ///< E6e
  std::atomic<uint64> orderby_handler_ref_adapter_smoke_success{0};  ///< E6e
  std::atomic<uint64> orderby_handler_ref_adapter_smoke_unsupported{0};  ///< E6e
  std::atomic<uint64> orderby_handler_ref_adapter_smoke_refs{0};  ///< E6e
  std::atomic<uint64> orderby_handler_ref_adapter_smoke_cmp_nonzero{0};  ///< E6e
  std::atomic<uint64>
      orderby_handler_ref_adapter_smoke_antisymmetric_success{0};  ///< E6e
  std::atomic<uint64>
      orderby_handler_ref_adapter_smoke_direction_match_success{0};  ///< E6e
  std::atomic<uint64>
      orderby_handler_ref_adapter_smoke_tiebreak_success{0};  ///< E6e
  std::atomic<uint64> worker_result_stable_ref_attempts{0};  ///< E6f
  std::atomic<uint64> worker_result_stable_ref_success{0};  ///< E6f
  std::atomic<uint64> worker_result_stable_ref_unsupported{0};  ///< E6f
  std::atomic<uint64> worker_result_stable_ref_bytes{0};  ///< E6f
  ...
  std::atomic<uint64> orderby_ref_adapter_shape_attempts{0};  ///< E6g-5b
  std::atomic<uint64> orderby_ref_adapter_shape_success{0};  ///< E6g-5b
  std::atomic<uint64> orderby_ref_adapter_shape_unsupported{0};  ///< E6g-5b
  std::atomic<uint64> orderby_ref_adapter_shape_rejects{0};  ///< E6g-5b
  std::atomic<uint64> orderby_ref_adapter_shape_cmp_nonzero{0};  ///< E6g-5b
  std::atomic<uint64>
  ...
  std::atomic<uint64> worker_execute_iterator_smoke_root_owned{0};
  ...
  std::atomic<uint64> worker_execute_iterator_smoke_blocked_output_fields{0};
  std::atomic<uint64> worker_execute_iterator_smoke_output_fields_cloned{0};
  std::atomic<uint64> worker_execute_iterator_smoke_result_contract_ready{0};
  std::atomic<uint64> worker_execute_iterator_smoke_blocked_result_contract{0};
  ...
  std::atomic<uint64> worker_execute_iterator_threaded_smoke_mat_rows{0};
  std::atomic<uint64> worker_execute_iterator_threaded_smoke_mat_errors{0};
  std::atomic<uint64> worker_execute_iterator_threaded_smoke_mat_id_sum{0};
  std::atomic<uint64> worker_execute_iterator_threaded_smoke_mat_v_sum{0};
  std::atomic<uint64> worker_execute_iterator_threaded_smoke_mat_id_v_sum{0};
  ...
  std::atomic<uint64> exchange_sort_stream_materialized_smoke_attempts{0};
  std::atomic<uint64> exchange_sort_stream_materialized_smoke_success{0};
  ...
  std::atomic<uint64> exchange_sort_frame_merge_edge_smoke_finishes{0};  ///< EOF
  ...
  void reset() {
    ...
    saved_order_group_restore_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    saved_order_group_clone_copy_smoke_attempts.store(
        0, std::memory_order_relaxed);
    saved_order_group_clone_copy_smoke_success.store(
        0, std::memory_order_relaxed);
    ...
    orderby_eligibility_contract_attempts.store(0, std::memory_order_relaxed);
    orderby_eligibility_contract_candidate_disabled.store(
        0, std::memory_order_relaxed);
    ...
    orderby_execution_preflight_missing_sort_param_runtime.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_worker_frame_producer.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_exchange_heap_read.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_leader_materialization.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_rowid_tiebreak.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_default_ordered_read.store(
        0, std::memory_order_relaxed);
    orderby_execution_preflight_missing_error_diagnostics.store(
        0, std::memory_order_relaxed);
    orderby_filesort_construct_smoke_attempts.store(
        0, std::memory_order_relaxed);
    orderby_filesort_construct_smoke_success.store(0,
                                                   std::memory_order_relaxed);
    orderby_filesort_construct_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    orderby_filesort_restored_order_contract_attempts.store(
        0, std::memory_order_relaxed);
    ...
    orderby_sort_param_init_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    orderby_sort_state_handoff_smoke_attempts.store(
        0, std::memory_order_relaxed);
    orderby_sort_state_handoff_smoke_success.store(
        0, std::memory_order_relaxed);
    orderby_sort_state_handoff_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    ...
    saved_order_chain_copy_smoke_unsupported.store(0,
                                                   std::memory_order_relaxed);
    saved_order_chain_flags_smoke_attempts.store(0, std::memory_order_relaxed);
    saved_order_chain_flags_smoke_success.store(0, std::memory_order_relaxed);
    saved_order_chain_flags_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    saved_order_chain_restore_smoke_attempts.store(0,
                                                   std::memory_order_relaxed);
    ...
    parallel_scan_iterator_order_gather_attempts.store(
        0, std::memory_order_relaxed);
    parallel_scan_iterator_order_gather_selected.store(
        0, std::memory_order_relaxed);
    parallel_scan_iterator_order_gather_smoke_rows.store(
        0, std::memory_order_relaxed);
    parallel_scan_iterator_row_value_attempts.store(
        0, std::memory_order_relaxed);
    parallel_scan_iterator_row_value_selected.store(
        0, std::memory_order_relaxed);
    parallel_scan_iterator_row_value_rows.store(0, std::memory_order_relaxed);
    ...
    worker_ref_ctx_cleanup_attempts.store(0, std::memory_order_relaxed);
    ...
    worker_ref_local_row_ownership_success.store(
        0, std::memory_order_relaxed);
    worker_ref_carrier_attempts.store(0, std::memory_order_relaxed);
    worker_ref_carrier_success.store(0, std::memory_order_relaxed);
    worker_ref_carrier_rows.store(0, std::memory_order_relaxed);
    worker_ref_carrier_finishes.store(0, std::memory_order_relaxed);
    worker_ref_carrier_errors.store(0, std::memory_order_relaxed);
    ...
    worker_icp_record_buffer_reject_probes.store(0,
                                                 std::memory_order_relaxed);
    orderby_worker_handler_ref_attempts.store(0, std::memory_order_relaxed);
    orderby_worker_handler_ref_success.store(0, std::memory_order_relaxed);
    orderby_worker_handler_ref_unsupported.store(0,
                                                 std::memory_order_relaxed);
    orderby_worker_handler_ref_bytes.store(0, std::memory_order_relaxed);
    orderby_worker_handler_ref_cmp_equal.store(0, std::memory_order_relaxed);
    orderby_handler_ref_wire_attempts.store(0, std::memory_order_relaxed);
    orderby_handler_ref_wire_success.store(0, std::memory_order_relaxed);
    ...
    orderby_handler_ref_two_row_post_cleanup_success.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_attempts.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_success.store(0,
                                                    std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_refs.store(0,
                                                 std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_cmp_nonzero.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_antisymmetric_success.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_direction_match_success.store(
        0, std::memory_order_relaxed);
    orderby_handler_ref_adapter_smoke_tiebreak_success.store(
        0, std::memory_order_relaxed);
    worker_result_stable_ref_attempts.store(0, std::memory_order_relaxed);
    worker_result_stable_ref_success.store(0, std::memory_order_relaxed);
    worker_result_stable_ref_unsupported.store(0, std::memory_order_relaxed);
    worker_result_stable_ref_bytes.store(0, std::memory_order_relaxed);
    worker_result_stable_ref_deep_copy_success.store(
        0, std::memory_order_relaxed);
    worker_result_stable_ref_normal_rejects.store(0,
                                                  std::memory_order_relaxed);
    ...
    stable_ref_pair_adapter_ref_length_mismatch.store(
        0, std::memory_order_relaxed);
    orderby_ref_adapter_shape_attempts.store(0, std::memory_order_relaxed);
    orderby_ref_adapter_shape_success.store(0, std::memory_order_relaxed);
    orderby_ref_adapter_shape_unsupported.store(0, std::memory_order_relaxed);
    orderby_ref_adapter_shape_rejects.store(0, std::memory_order_relaxed);
    orderby_ref_adapter_shape_cmp_nonzero.store(0,
                                                std::memory_order_relaxed);
    ...
    worker_execute_iterator_smoke_root_iterator_constructed.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_root_owned.store(0,
                                                  std::memory_order_relaxed);
    ...
    worker_execute_iterator_smoke_read_success.store(0,
                                                     std::memory_order_relaxed);
    worker_execute_iterator_smoke_blocked_result.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_result_bound.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_result_bound_before_root_read.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_blocked_output_fields.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_output_fields_cloned.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_result_contract_ready.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_smoke_blocked_result_contract.store(
        0, std::memory_order_relaxed);
    ...
    worker_execute_iterator_threaded_smoke_value_id_v_sum.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_threaded_smoke_mat_rows.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_threaded_smoke_mat_errors.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_threaded_smoke_mat_id_sum.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_threaded_smoke_mat_v_sum.store(
        0, std::memory_order_relaxed);
    worker_execute_iterator_threaded_smoke_mat_id_v_sum.store(
        0, std::memory_order_relaxed);
    ...
    exchange_sort_stream_heap_smoke_heap_removes.store(
        0, std::memory_order_relaxed);
    exchange_sort_stream_materialized_smoke_attempts.store(
        0, std::memory_order_relaxed);
    exchange_sort_stream_materialized_smoke_success.store(
        0, std::memory_order_relaxed);
    exchange_sort_stream_materialized_smoke_unsupported.store(
        0, std::memory_order_relaxed);
    ...
    exchange_sort_frame_merge_smoke_finishes.store(0,
                                                   std::memory_order_relaxed);
    exchange_sort_frame_merge_edge_smoke_rows.store(
        0, std::memory_order_relaxed);
    exchange_sort_frame_merge_edge_smoke_finishes.store(
        0, std::memory_order_relaxed);
    exchange_sort_frame_merge_edge_smoke_errors.store(
        0, std::memory_order_relaxed);
...
class Gather_operator {
  ...
  */
  ...
  /**
    ...
    @retval true   Smoke pass failed
  */
  bool run_exchange_sort_smoke(THD *leader_thd, TABLE *leader_table = nullptr);
  ...
  */
  ...
  /**
    ...
    values to send PQWR ROW/FINISH frames. The leader drains those frames before
    waiting for the worker. It does not open worker TABLEs, call handler/InnoDB,
