...
class Arg_comparator {
  ...
  */
  ...
  bool clone(Arg_comparator *origin_cmp, Item_result_field *result);
...
class Item_bool_func2 : public Item_bool_func {
 ...
 public:
  ...
  bool refix_fields(THD *thd, Item **ref) override;
};
...
class Item_func_interval final : public Item_int_func {
 ...
 public:
  ...
  Item_func_interval(const POS &pos, Item_row *tmprow)
      : super(pos, tmprow), row(tmprow), intervals(0) {
    allowed_arg_cols = 0;
  }
...
class in_vector {
  ...
  */
  ...
  virtual in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) {
    return nullptr;
  }
...
class in_string final : public in_vector {
 ...
 public:
  ...
  // after fill, used_count will be set to 0. so it should use count.
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_string(thd->mem_root, m_size, collation);
  }
...
class in_longlong : public in_vector {
 ...
 public:
  ...
  bool compare_elems(uint pos1, uint pos2) const override;
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_longlong(thd->mem_root, m_size);
  }
...
class in_datetime_as_longlong final : public in_longlong {
 public:
  ...
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_datetime_as_longlong(thd->mem_root, m_size);
  }
...
class in_time_as_longlong final : public in_longlong {
 public:
  ...
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_time_as_longlong(thd->mem_root, m_size);
  }
...
class in_datetime final : public in_longlong {
 ...
 public:
  ...
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_datetime(thd->mem_root, warn_item, m_size);
  }
...
class in_double final : public in_vector {
 ...
 public:
  ...
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_double(thd->mem_root, m_size);
  }
...
class in_decimal final : public in_vector {
 ...
 public:
  ...
  bool compare_elems(uint pos1, uint pos2) const override;
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    return new (thd->mem_root) in_decimal(thd->mem_root, m_size);
  }
...
class cmp_item {
  ...
  */
  ...
  virtual cmp_item *pq_clone(THD *thd MY_ATTRIBUTE((unused))) {
    return nullptr;
  }
...
class cmp_item_string final : public cmp_item_scalar {
 ...
 public:
  ...
  cmp_item *pq_clone(THD *thd) override;
};
...
class cmp_item_int final : public cmp_item_scalar {
 ...
 public:
  ...
  cmp_item *make_same() override;
  cmp_item *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override;
};
...
class Item_func_case final : public Item_func {
  ...
  String tmp_value;
  uint ncases;
  Item_result cmp_type{INVALID_RESULT};
  DTCollation cmp_collation;
...
class Item_func_in final : public Item_func_opt_neg {
  ...
  */
  ...
  /// It's only used for in-list conversion. Because Item_func_in calls
  /// apply_is_true before fix_fields, this variable records whether such
  /// a calling is done. If it does, same calling is needed after Item_func_in
  /// is converted into Item_in_subselect. Otherwise, the conversion might
  /// cause incorrect result.
  bool need_apply_is_true{false};
  ...
  */
  ...
  inline void apply_is_true() override {
    Item_func_opt_neg ::apply_is_true();
    need_apply_is_true = true;
  }
  Item *pq_clone(THD *thd, Query_block *select) override;
  bool pq_copy_from(THD *thd, Query_block *select, Item *item) override;
...
class in_row final : public in_vector {
  ...
  */
  ...
  in_vector *pq_clone(THD *thd MY_ATTRIBUTE((unused))) override {
    cmp_item *new_cmp_row = tmp.get()->pq_clone(thd);
    if (!new_cmp_row) return nullptr;
    return new (thd->mem_root)
        in_row(thd->mem_root, m_size, static_cast<cmp_item_row *>(new_cmp_row));
  }
...
class Item_func_like final : public Item_bool_func2 {
 ...
 public:
  ...
  void print(const THD *thd, String *str,
             enum_query_type query_type) const override;
  Item *get_escape_item() {
    return (escape_was_used_in_parsing() ? args[2] : nullptr);
  }
  // void update_used_tables() override;
...
class Item_cond : public Item_bool_func {
 ...
 public:
  ...
  bool refix_fields(THD *, Item **ref) override;
  void fix_after_pullout(Query_block *parent_query_block,
                         Query_block *removed_query_block) override;
  ...
  bool ignore_unknown() const { return abort_on_null; }
  bool equality_substitution_analyzer(uchar **) override { return true; }
  bool replace_with_base_item(uchar *) override;
  bool pq_copy_from(THD *thd, Query_block *select, Item *item) override;
};
...
uint collect_cmp_types(Item **items, uint nitems, bool skip_nulls = false);
