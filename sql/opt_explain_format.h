...
class qep_row {
  ...
  */
  ...
  ///< "cut_table" column of JSON format
  mem_root_str col_cut_table_name;
  ///< "divided_table" column of JSON format
  mem_root_str col_divided_table_name;
  ///< "parallel_query_degree" column of JSON format
  column<uint> col_pq_dop;
