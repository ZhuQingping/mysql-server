...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(clone_preflight_success,
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_qep_tab_skeleton_attempts,
                                worker_qep_tab_skeleton_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_qep_tab_skeleton_success,
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_qep_tab_table_attach_attempts,
                                worker_qep_tab_table_attach_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_qep_tab_table_attach_success,
                                worker_qep_tab_table_attach_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_qep_tab_table_attach_unsupported,
                                worker_qep_tab_table_attach_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_table_ref_clone_attempts,
                                worker_table_ref_clone_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_table_ref_clone_success,
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_table_scalar_clone_attempts,
                                worker_table_scalar_clone_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_table_scalar_clone_success,
                                worker_table_scalar_clone_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_table_scalar_clone_unsupported,
                                worker_table_scalar_clone_unsupported)
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_range_scan_clone_success,
                                worker_range_scan_clone_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(worker_range_scan_clone_unsupported,
                                worker_range_scan_clone_unsupported)
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_group_restore_smoke_attempts,
                                saved_order_group_restore_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_group_restore_smoke_success,
                                saved_order_group_restore_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_group_restore_smoke_unsupported,
                                saved_order_group_restore_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_group_clone_copy_smoke_attempts,
                                saved_order_group_clone_copy_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_group_clone_copy_smoke_success,
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_eligibility_contract_attempts,
                                orderby_eligibility_contract_attempts)
...
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(
    ...
    orderby_filesort_restored_order_contract_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(
    orderby_filesort_restored_order_contract_success,
    orderby_filesort_restored_order_contract_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(
    orderby_filesort_restored_order_contract_unsupported,
    orderby_filesort_restored_order_contract_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_param_init_smoke_attempts,
                                orderby_sort_param_init_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_param_init_smoke_success,
                                orderby_sort_param_init_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_param_init_smoke_unsupported,
                                orderby_sort_param_init_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_state_handoff_smoke_attempts,
                                orderby_sort_state_handoff_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_state_handoff_smoke_success,
                                orderby_sort_state_handoff_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(orderby_sort_state_handoff_smoke_unsupported,
                                orderby_sort_state_handoff_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_copy_smoke_attempts,
                                saved_order_chain_copy_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_copy_smoke_success,
                                saved_order_chain_copy_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_copy_smoke_unsupported,
                                saved_order_chain_copy_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_flags_smoke_attempts,
                                saved_order_chain_flags_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_flags_smoke_success,
                                saved_order_chain_flags_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_flags_smoke_unsupported,
                                saved_order_chain_flags_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_restore_smoke_attempts,
                                saved_order_chain_restore_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_restore_smoke_success,
                                saved_order_chain_restore_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_restore_smoke_unsupported,
                                saved_order_chain_restore_smoke_unsupported)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_clone_copy_smoke_attempts,
                                saved_order_chain_clone_copy_smoke_attempts)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_clone_copy_smoke_success,
                                saved_order_chain_clone_copy_smoke_success)
DEFINE_PQ_CLONE_PROBE_SHOW_FUNC(saved_order_chain_clone_copy_smoke_unsupported,
                                saved_order_chain_clone_copy_smoke_unsupported)
...
static int show_pq_ranges_dispatched(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.ranges_dispatched.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_empty_worker_ranges(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.empty_worker_ranges.load(std::memory_order_relaxed));
  return 0;
}
...
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(secondary_mvi_reject_probes,
                                    secondary_mvi_reject_probes)
...
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(secondary_record_buffer_nonnull_probes,
                                    secondary_record_buffer_nonnull_probes)
...
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_attempts,
                                    worker_ref_carrier_attempts)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_success,
                                    worker_ref_carrier_success)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_rows,
                                    worker_ref_carrier_rows)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_finishes,
                                    worker_ref_carrier_finishes)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_errors,
                                    worker_ref_carrier_errors)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_cleanup,
                                    worker_ref_carrier_cleanup)
DEFINE_PQ_SECONDARY_RANGE_SHOW_FUNC(worker_ref_carrier_unsupported,
...
static int show_pq_probe_gate_unsupported(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.probe_gate_unsupported.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_probe_thread_budget_unsupported(THD *, SHOW_VAR *var,
                                                   char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(pq_global_stats
                                      .probe_thread_budget_unsupported.load(
                                          std::memory_order_relaxed));
  return 0;
}

static int show_pq_probe_init_unsupported(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.probe_init_unsupported.load(std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_worker_producer_smoke_runs(THD *, SHOW_VAR *var,
                                              char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.worker_producer_smoke_runs.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_worker_open_smoke_runs(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.worker_open_smoke_runs.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_worker_handler_smoke_runs(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.worker_handler_smoke_runs.load(std::memory_order_relaxed));
  return 0;
}
...
DEFINE_PQ_WORKER_ATTACH_SHOW_FUNC(stable_ref_adapter_attempts,
                                  stable_ref_adapter_attempts)
DEFINE_PQ_WORKER_ATTACH_SHOW_FUNC(stable_ref_adapter_success,
                                  stable_ref_adapter_success)
DEFINE_PQ_WORKER_ATTACH_SHOW_FUNC(stable_ref_adapter_unsupported,
                                  stable_ref_adapter_unsupported)
DEFINE_PQ_WORKER_ATTACH_SHOW_FUNC(stable_ref_adapter_bytes,
                                  stable_ref_adapter_bytes)
DEFINE_PQ_WORKER_ATTACH_SHOW_FUNC(stable_ref_adapter_deep_copy_success,
...
static int show_pq_worker_result_smoke_rows(THD *, SHOW_VAR *var, char *buf) {
  ...
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.worker_result_smoke_rows.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_worker_result_smoke_finishes(THD *, SHOW_VAR *var,
                                                char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) =
      (longlong)(pq_global_stats.worker_result_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_worker_result_smoke_errors(THD *, SHOW_VAR *var,
                                              char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(pq_global_stats.worker_result_smoke_errors
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_attempts,
    worker_execute_iterator_smoke_attempts)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_blocked_clone,
    worker_execute_iterator_smoke_blocked_clone)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    ...
    worker_execute_iterator_smoke_iterator_constructed)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_root_attached,
    worker_execute_iterator_smoke_root_attached)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_root_iterator_constructed,
    worker_execute_iterator_smoke_root_iterator_constructed)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_root_owned,
    worker_execute_iterator_smoke_root_owned)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_blocked_root_init,
    worker_execute_iterator_smoke_blocked_root_init)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    ...
    worker_execute_iterator_smoke_blocked_init)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_init_success,
    worker_execute_iterator_smoke_init_success)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_blocked_read,
    worker_execute_iterator_smoke_blocked_read)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_read_success,
    worker_execute_iterator_smoke_read_success)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_blocked_result,
    worker_execute_iterator_smoke_blocked_result)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_result_bound,
    worker_execute_iterator_smoke_result_bound)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_result_bound_before_root_read,
    worker_execute_iterator_smoke_result_bound_before_root_read)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_blocked_output_fields,
    worker_execute_iterator_smoke_blocked_output_fields)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    ...
    worker_execute_iterator_smoke_blocked_result_send)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_result_row_sent,
    worker_execute_iterator_smoke_result_row_sent)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_result_eof_sent,
    worker_execute_iterator_smoke_result_eof_sent)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_result_restored,
    worker_execute_iterator_smoke_result_restored)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    ...
    worker_execute_iterator_smoke_blocked_execute)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_smoke_success, worker_execute_iterator_smoke_success)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_attempts,
    worker_execute_iterator_threaded_smoke_attempts)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_success,
    worker_execute_iterator_threaded_smoke_success)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_blocked_setup,
    worker_execute_iterator_threaded_smoke_blocked_setup)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    ...
    worker_execute_iterator_threaded_smoke_drain_errors)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_value_rows,
    worker_execute_iterator_threaded_smoke_value_rows)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_value_errors,
    worker_execute_iterator_threaded_smoke_value_errors)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_value_id_sum,
    worker_execute_iterator_threaded_smoke_value_id_sum)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
    worker_execute_iterator_threaded_smoke_value_v_sum,
    worker_execute_iterator_threaded_smoke_value_v_sum)
DEFINE_PQ_WORKER_EXECUTE_ITERATOR_SHOW_FUNC(
...
static int show_pq_exchange_smoke_rows(THD *, SHOW_VAR *var, char *buf) {
  ...
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_smoke_rows.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_smoke_finishes(THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_smoke_finishes.load(std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_row_image_smoke_rows(THD *, SHOW_VAR *var,
                                                 char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) =
      (longlong)(pq_global_stats.exchange_row_image_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_row_image_smoke_finishes(THD *, SHOW_VAR *var,
                                                     char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) =
      (longlong)(pq_global_stats.exchange_row_image_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_partial_group_smoke_rows(THD *, SHOW_VAR *var,
                                                     char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) =
      (longlong)(pq_global_stats.exchange_partial_group_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_exchange_sort_frame_smoke_rows(THD *, SHOW_VAR *var,
                                                  char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_smoke_finishes(THD *, SHOW_VAR *var,
                                                      char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_smoke_errors(THD *, SHOW_VAR *var,
                                                    char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_smoke_errors.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_orderby_worker_frame_producer_smoke_attempts(THD *,
                                                                SHOW_VAR *var,
                                                                char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.orderby_worker_frame_producer_smoke_attempts.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_orderby_worker_frame_producer_smoke_success(THD *,
                                                               SHOW_VAR *var,
                                                               char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.orderby_worker_frame_producer_smoke_success.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_orderby_worker_frame_producer_smoke_unsupported(
    THD *, SHOW_VAR *var, char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.orderby_worker_frame_producer_smoke_unsupported.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_exchange_sort_worker_frame_smoke_rows(THD *, SHOW_VAR *var,
  ...
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_worker_frame_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_worker_frame_smoke_finishes(THD *,
                                                             SHOW_VAR *var,
                                                             char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_worker_frame_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_worker_frame_smoke_errors(THD *,
                                                           SHOW_VAR *var,
                                                           char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_worker_frame_smoke_errors.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_exchange_sort_frame_merge_smoke_rows(THD *, SHOW_VAR *var,
  ...
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_merge_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_merge_smoke_finishes(THD *,
                                                            SHOW_VAR *var,
                                                            char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_merge_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_merge_edge_smoke_rows(THD *,
                                                             SHOW_VAR *var,
                                                             char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_merge_edge_smoke_rows.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_merge_edge_smoke_finishes(THD *,
                                                                 SHOW_VAR *var,
                                                                 char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_merge_edge_smoke_finishes.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_exchange_sort_frame_merge_edge_smoke_errors(THD *,
                                                               SHOW_VAR *var,
                                                               char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.exchange_sort_frame_merge_edge_smoke_errors.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_groupby_dop1_factory_attempts(THD *, SHOW_VAR *var,
                                                 char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.groupby_dop1_factory_attempts.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_groupby_dop1_typed_count_executed(THD *, SHOW_VAR *var,
                                                     char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.groupby_dop1_typed_count_executed.load(
          std::memory_order_relaxed));
  return 0;
}

static int show_pq_groupby_dop1_typed_minmax_executed(THD *, SHOW_VAR *var,
                                                      char *buf) {
  var->type = SHOW_LONGLONG;
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.groupby_dop1_typed_minmax_executed.load(
          std::memory_order_relaxed));
  return 0;
}
...
static int show_pq_groupby_dop1_factory_fallback(THD *, SHOW_VAR *var,
  ...
  var->value = buf;
  *((longlong *)buf) = (longlong)(
      pq_global_stats.groupby_dop1_factory_fallback.load(
          std::memory_order_relaxed));
  return 0;
}
...
SHOW_VAR status_vars[] = {
    ...
    {"Parallel_orderby_eligibility_contract_attempts",
     (char *)&show_pq_orderby_eligibility_contract_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_eligibility_contract_candidate_disabled",
     (char *)&show_pq_orderby_eligibility_contract_candidate_disabled,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_orderby_filesort_restored_order_contract_success",
     (char *)&show_pq_orderby_filesort_restored_order_contract_success,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_filesort_restored_order_contract_unsupported",
     (char *)&show_pq_orderby_filesort_restored_order_contract_unsupported,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_param_init_smoke_attempts",
     (char *)&show_pq_orderby_sort_param_init_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_param_init_smoke_success",
     (char *)&show_pq_orderby_sort_param_init_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_param_init_smoke_unsupported",
     (char *)&show_pq_orderby_sort_param_init_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_state_handoff_smoke_attempts",
     (char *)&show_pq_orderby_sort_state_handoff_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_state_handoff_smoke_success",
     (char *)&show_pq_orderby_sort_state_handoff_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_sort_state_handoff_smoke_unsupported",
     (char *)&show_pq_orderby_sort_state_handoff_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_copy_smoke_attempts",
     (char *)&show_pq_saved_order_chain_copy_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_copy_smoke_success",
     (char *)&show_pq_saved_order_chain_copy_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_copy_smoke_unsupported",
     (char *)&show_pq_saved_order_chain_copy_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_flags_smoke_attempts",
     (char *)&show_pq_saved_order_chain_flags_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_flags_smoke_success",
     (char *)&show_pq_saved_order_chain_flags_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_flags_smoke_unsupported",
     (char *)&show_pq_saved_order_chain_flags_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_restore_smoke_attempts",
     (char *)&show_pq_saved_order_chain_restore_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_restore_smoke_success",
     (char *)&show_pq_saved_order_chain_restore_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_restore_smoke_unsupported",
     (char *)&show_pq_saved_order_chain_restore_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_clone_copy_smoke_attempts",
     (char *)&show_pq_saved_order_chain_clone_copy_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_clone_copy_smoke_success",
     (char *)&show_pq_saved_order_chain_clone_copy_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_chain_clone_copy_smoke_unsupported",
     (char *)&show_pq_saved_order_chain_clone_copy_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_clone_preflight_success",
    ...
    {"Parallel_worker_qep_tab_skeleton_attempts",
     (char *)&show_pq_worker_qep_tab_skeleton_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_qep_tab_skeleton_success",
     (char *)&show_pq_worker_qep_tab_skeleton_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_qep_tab_table_attach_attempts",
     (char *)&show_pq_worker_qep_tab_table_attach_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_qep_tab_table_attach_success",
     (char *)&show_pq_worker_qep_tab_table_attach_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_qep_tab_table_attach_unsupported",
     (char *)&show_pq_worker_qep_tab_table_attach_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_table_ref_clone_attempts",
     (char *)&show_pq_worker_table_ref_clone_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_table_ref_clone_success",
     (char *)&show_pq_worker_table_ref_clone_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_table_scalar_clone_attempts",
     (char *)&show_pq_worker_table_scalar_clone_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_table_scalar_clone_success",
     (char *)&show_pq_worker_table_scalar_clone_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_table_scalar_clone_unsupported",
     (char *)&show_pq_worker_table_scalar_clone_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_range_scan_clone_success",
     (char *)&show_pq_worker_range_scan_clone_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_range_scan_clone_unsupported",
     (char *)&show_pq_worker_range_scan_clone_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_saved_order_group_clone_copy_smoke_attempts",
     (char *)&show_pq_saved_order_group_clone_copy_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_group_clone_copy_smoke_success",
     (char *)&show_pq_saved_order_group_clone_copy_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_group_clone_copy_smoke_unsupported",
     (char *)&show_pq_saved_order_group_clone_copy_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_group_restore_smoke_attempts",
     (char *)&show_pq_saved_order_group_restore_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_group_restore_smoke_success",
     (char *)&show_pq_saved_order_group_restore_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_saved_order_group_restore_smoke_unsupported",
     (char *)&show_pq_saved_order_group_restore_smoke_unsupported, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_exchange_row_image_smoke_finishes",
     (char *)&show_pq_exchange_row_image_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_row_image_smoke_rows",
     (char *)&show_pq_exchange_row_image_smoke_rows, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_partial_group_smoke_finishes",
     (char *)&show_pq_exchange_partial_group_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_exchange_sort_frame_smoke_errors",
     (char *)&show_pq_exchange_sort_frame_smoke_errors, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_sort_frame_merge_edge_smoke_errors",
     (char *)&show_pq_exchange_sort_frame_merge_edge_smoke_errors, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_sort_frame_merge_edge_smoke_finishes",
     (char *)&show_pq_exchange_sort_frame_merge_edge_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_exchange_sort_frame_merge_smoke_finishes",
     ...
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_sort_frame_merge_smoke_rows",
     (char *)&show_pq_exchange_sort_frame_merge_smoke_rows, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_sort_frame_smoke_finishes",
     (char *)&show_pq_exchange_sort_frame_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_exchange_sort_frame_smoke_rows",
     (char *)&show_pq_exchange_sort_frame_smoke_rows, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_worker_frame_producer_smoke_attempts",
     (char *)&show_pq_orderby_worker_frame_producer_smoke_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_orderby_worker_frame_producer_smoke_success",
     (char *)&show_pq_orderby_worker_frame_producer_smoke_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_exchange_sort_worker_frame_smoke_finishes",
     (char *)&show_pq_exchange_sort_worker_frame_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_groupby_dop1_temp_table_executed",
     ...
     SHOW_SCOPE_GLOBAL},
    {"Parallel_groupby_dop1_typed_count_executed",
     (char *)&show_pq_groupby_dop1_typed_count_executed, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_probe_unsupported", (char *)&show_pq_probe_unsupported,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_probe_gate_unsupported",
     (char *)&show_pq_probe_gate_unsupported, SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_probe_init_unsupported",
    ...
    {"Parallel_rows_scanned", (char *)&show_pq_rows_scanned, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_scan_iterator_order_gather_attempts",
     (char *)&show_pq_parallel_scan_iterator_order_gather_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_scan_iterator_order_gather_selected",
     (char *)&show_pq_parallel_scan_iterator_order_gather_selected, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_scan_iterator_order_gather_smoke_rows",
     (char *)&show_pq_parallel_scan_iterator_order_gather_smoke_rows, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_scan_iterator_row_value_attempts",
    ...
    {"Parallel_ranges_built", (char *)&show_pq_ranges_built, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_ranges_dispatched", (char *)&show_pq_ranges_dispatched,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_ref_carrier_attempts",
     (char *)&show_pq_worker_ref_carrier_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_cleanup",
     (char *)&show_pq_worker_ref_carrier_cleanup, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_errors",
     (char *)&show_pq_worker_ref_carrier_errors, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_failures",
     (char *)&show_pq_worker_ref_carrier_failures, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_finishes",
     (char *)&show_pq_worker_ref_carrier_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_rows",
     (char *)&show_pq_worker_ref_carrier_rows, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_ref_carrier_success",
     (char *)&show_pq_worker_ref_carrier_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_secondary_mvi_reject_probes",
     (char *)&show_pq_secondary_mvi_reject_probes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_secondary_record_buffer_nonnull_probes",
     (char *)&show_pq_secondary_record_buffer_nonnull_probes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_result_stable_ref_adapter_attempts",
     (char *)&show_pq_stable_ref_adapter_attempts, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_stable_ref_adapter_bytes",
     (char *)&show_pq_stable_ref_adapter_bytes, SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_stable_ref_adapter_deep_copy_success",
     (char *)&show_pq_stable_ref_adapter_deep_copy_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_stable_ref_adapter_ref_length_mismatch",
     (char *)&show_pq_stable_ref_adapter_ref_length_mismatch, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_stable_ref_adapter_success",
     (char *)&show_pq_stable_ref_adapter_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_open_smoke_runs",
     (char *)&show_pq_worker_open_smoke_runs, SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_producer_smoke_runs",
     (char *)&show_pq_worker_producer_smoke_runs, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_smoke_errors",
     (char *)&show_pq_worker_result_smoke_errors, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_result_smoke_finishes",
     (char *)&show_pq_worker_result_smoke_finishes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_smoke_blocked_init",
     (char *)&show_pq_worker_execute_iterator_smoke_blocked_init, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_smoke_blocked_read",
     (char *)&show_pq_worker_execute_iterator_smoke_blocked_read, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_init_success",
     (char *)&show_pq_worker_execute_iterator_smoke_init_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_read_success",
     (char *)&show_pq_worker_execute_iterator_smoke_read_success, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_blocked_result",
     (char *)&show_pq_worker_execute_iterator_smoke_blocked_result, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_result_bound",
     (char *)&show_pq_worker_execute_iterator_smoke_result_bound, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_result_bound_before_read",
     (char *)&show_pq_worker_execute_iterator_smoke_result_bound_before_root_read,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_blocked_output_fields",
     (char *)&show_pq_worker_execute_iterator_smoke_blocked_output_fields,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_smoke_result_row_sent",
     (char *)&show_pq_worker_execute_iterator_smoke_result_row_sent, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_result_eof_sent",
     (char *)&show_pq_worker_execute_iterator_smoke_result_eof_sent, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_result_restored",
     (char *)&show_pq_worker_execute_iterator_smoke_result_restored, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_smoke_root_attached",
     (char *)&show_pq_worker_execute_iterator_smoke_root_attached, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_root_iterator_ok",
     (char *)&show_pq_worker_execute_iterator_smoke_root_iterator_constructed,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_root_owned",
     (char *)&show_pq_worker_execute_iterator_smoke_root_owned, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_smoke_blocked_root_init",
     (char *)&show_pq_worker_execute_iterator_smoke_blocked_root_init,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_smoke_worker_table_opened",
     (char *)&show_pq_worker_execute_iterator_smoke_worker_table_opened,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_thread_smoke_attempts",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_attempts,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_thread_smoke_blocked_preflight",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_blocked_preflight,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    ...
    {"Parallel_worker_execute_iterator_thread_smoke_value_id_sum",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_value_id_sum,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_thread_smoke_value_id_v_sum",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_value_id_v_sum,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_thread_smoke_value_rows",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_value_rows,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
    {"Parallel_worker_execute_iterator_thread_smoke_value_v_sum",
     (char *)&show_pq_worker_execute_iterator_threaded_smoke_value_v_sum,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
