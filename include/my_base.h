...
enum ha_extra_function {
  ...
  */
  ...
  /*
    For dstore engine trigger to flush statistics by background.
  */
  HA_EXTRA_FLUSH_STATISTICS_BY_BACKGROUND,
  /*
    For dstore engine trigger to flush statistics when alter table.
  */
...
constexpr const ulong HA_USES_DSTORE_DDL_COMMENT{1UL << 31};
...
#define HA_ERR_NOT_ALLOWED_PARTITION_TYPE 210
#define HA_ERR_REORG_WRONG_VALUES_RANGE 211
...
constexpr ulonglong MAX_FILE_SIZE = LLONG_MAX;

#define HA_VARCHAR_PACKLENGTH(field_length) ((field_length) < 256 ? 1 : 2)

/** Values for storage_engine_mode sysvar. */
enum enum_storage_engine_mode {
  ONLY_DSTORE = 0,
  ONLY_INNODB = 1,
  BOTH_STORAGE_ENGINE = 2
};
