...
extern void _pq_stack_copy(CODE_STATE *leader_cs);
extern void _pq_stack_reset();
...
#define DBUG_PQ_ENTER(leader) _pq_stack_copy(leader)
#define DBUG_PQ_RESET() _pq_stack_reset()
...
#define DBUG_PQ_ENTER(leader) \
  do {                        \
  } while (0)
#define DBUG_PQ_RESET() \
  do {                  \
  } while (0)
#endif
