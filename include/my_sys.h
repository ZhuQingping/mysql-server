...
#define DEBUG_SYNC_C_WITH_LEN(_sync_point_name_, _len_)       \
  do {                                                        \
    if (debug_sync_C_callback_ptr != NULL)                    \
      (*debug_sync_C_callback_ptr)(_sync_point_name_, _len_); \
  } while (0)
...
#else
#define DEBUG_SYNC_C(_sync_point_name_)
#define DEBUG_SYNC_C_WITH_LEN(_sync_point_name_, len)
#define DEBUG_SYNC_C_IF_THD(thd, _sync_point_name_)
