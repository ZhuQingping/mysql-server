...
int mysql_wallog_open(MYSQL *mysql, MYSQL_WAL_RPL *rpl);
int mysql_wallog_fetch(MYSQL *mysql, MYSQL_WAL_RPL *rpl);
void mysql_wallog_close(MYSQL *mysql, MYSQL_WAL_RPL *rpl);
bool server_looks_like_mariadb(MYSQL *mysql);
