...
- Next recommended action: 保持实验变量默认 OFF；下一步进入 V2-12A-3.4d `TEMPTABLE_AGGREGATE` SQL result smoke / eligibility 白名单拆分；`pq_worker_scan_next()` 继续 disabled。
