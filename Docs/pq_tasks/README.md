...
- Latest commits:
  ...
  - M11-E1 code: pending commit，Exchange_sort commercial shape compile-only
- Phase 8 validation:
...
- Next recommended action: 提交 M11-E1；随后进入 M11-E2 sorted row-frame adapter smoke 设计，不混入 M11-F ref/ICP worker path。
