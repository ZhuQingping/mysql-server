...
- Active update: M11-E5g-4a ORDER BY preflight runtime-state detail 已完成本地实现、验证和 Code/Doc/Test Review；不打开真实 ORDER BY execution、默认 worker MQ consumption 或默认 ordered `Read()`。
...
- Current M11-E5g correction: M11-E5g-2 和 M11-E5g-3 已提交；M11-E5g-4 design-only 已完成；M11-E5g-4a 本地实现、验证和 review 已完成。下方超长历史摘要如仍出现 5g-2 waiting final review，不作为当前状态来源。
