...
- Next recommended action: 保持实验变量默认 OFF；继续构造 DOP=2 debug shadow 的多 range correctness 风险用例；`pq_worker_scan_next()` 继续 disabled。
