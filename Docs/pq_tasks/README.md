...
- Next recommended action: 继续 V2-8J-4 DOP=1 real full scan gate；接 SQL worker loop / Exchange sink，并实现 wait/kill policy，`pq_worker_scan_next()` 继续 disabled。
