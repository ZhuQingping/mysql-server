...
- Next recommended action: 进入 E5d-S1 compile-only saved state contract shape；保持 fail-closed，不进入 Filesort construction，不放开 `HAS_ORDER_BY`。
