...
| V2-12A-3 - DOP1 Partial Group Execution | V2-12A-3.2 Completed | Codex Orchestrator + Explorer Agent | [v2-12a-3-dop1-partial-group-execution.md](v2-12a-3-dop1-partial-group-execution.md) | 新增默认 OFF gate 和 `AccessPath::AGGREGATE` factory skeleton；GROUP BY 执行仍 fallback |
