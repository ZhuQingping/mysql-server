...
- Next recommended action: 保持实验变量默认 OFF；下一步进入 P1 regression expansion 和 feature expansion design；`pq_worker_scan_next()` 继续 disabled。
