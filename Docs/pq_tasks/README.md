...
- Latest commits:
  ...
  - M11-E2 code: pending commit，Exchange_sort cached row-frame adapter smoke
- Phase 8 validation:
...
- Next recommended action: 提交 M11-E2；随后进入 M11-E3 ParallelScanIterator order gather debug path 设计，不混入 M11-F ref/ICP worker path。
