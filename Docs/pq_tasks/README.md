...
- Active update: M11-F5-C1 debug-only partition reject diagnostic 已完成本地
  实现和验证，等待 Code / Docs / Test Review。新增
  ...
  replay 和完整 `parallel_query` suite 89/89 通过。F5-C design 已提交为
...
- Next recommended action: Code / Docs / Test Review M11-F5-C1；若
