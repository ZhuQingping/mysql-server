...
| V2-11A/B/C/D - Regression Expansion | Large kill Completed; MDL/vars pending | Codex Orchestrator + Worker Agents | [v2-11-regression-expansion.md](v2-11-regression-expansion.md) | 新增 prepare state、row image datatypes、LIMIT/counter 和 large external KILL 回归 |
