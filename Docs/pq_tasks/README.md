...
- Next recommended action: 进入 M9-D3b iterator scaffold，并在 D3b/D3c 期间落地 ref-specific counters 作为 D3d 用户可见 gate 前置。
