...
- Next recommended action: 保持实验变量默认 OFF；下一步评估 V2-9E experimental DOP>1 gate，初始只允许 DOP=2；`pq_worker_scan_next()` 继续 disabled。
