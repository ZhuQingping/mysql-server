...
- Active orchestration:
  ...
  - [v2-9e-experimental-dop2-gate.md](v2-9e-experimental-dop2-gate.md): V2-9E 已新增默认 OFF 的 `parallel_query_experimental_threaded_dop`，无 debug 下初始只允许 DOP=2；完整 suite 34 项通过。
...
| V2-9E - Experimental DOP2 Gate | Completed | Codex Orchestrator | [v2-9e-experimental-dop2-gate.md](v2-9e-experimental-dop2-gate.md) | 新增默认 OFF 的 `parallel_query_experimental_threaded_dop`；无 debug 下只打开 DOP=2 threaded full scan；完整 suite 34 项通过 |
