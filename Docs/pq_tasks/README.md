...
| V2-11A/B - Regression Expansion | Completed | Codex Orchestrator + Worker Agents | [v2-11-regression-expansion.md](v2-11-regression-expansion.md) | 新增 prepare state 和 row image datatypes 回归；完整 suite 46 项通过 |
