...
- Next recommended action: 继续 V2-8J-4 DOP=1 real full scan gate；实现 wait/kill policy，并在 debug gate 下验证真实 DOP=1 full scan，`pq_worker_scan_next()` 继续 disabled。
