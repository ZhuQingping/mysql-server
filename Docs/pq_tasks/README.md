...
- Next recommended action: 补 V2-12B worker error 和 external kill 专门回归；之后评估 DOP4 GROUP BY partial gate expansion；`pq_worker_scan_next()` 继续 disabled。
