...
static monitor_info_t innodb_counter_info[] = {
    ...
    {"purge_nodes_waiting_max_usec", "purge",
     "Microseconds to wait while innodb_purge_threads nodes of purge query "
     "graph will be free",
     MONITOR_DISPLAY_CURRENT, MONITOR_DEFAULT_START,
     MONITOR_PURGE_NODES_WAITING_MAX},

    {"purge_nodes_waiting_average_usec", "purge",
     "Average microseconds while 1,2,...,innodb_purge_threads nodes of purge"
     " query graph will be free",
     MONITOR_DISPLAY_CURRENT, MONITOR_DEFAULT_START,
     MONITOR_PURGE_NODES_WAITING_AVERAGE},

    {"purge_nodes_waiting_min_usec", "purge",
     "Microseconds to wait while one node of purge query graph will be free",
     MONITOR_DISPLAY_CURRENT, MONITOR_DEFAULT_START,
     MONITOR_PURGE_NODES_WAITING_MIN},
    ...
    {"dml_reads_skipped_by_offset_pushdown", "dml",
     "Number of rows skipped by offset pushdown",
     static_cast<monitor_type_t>(MONITOR_EXISTING), MONITOR_DEFAULT_START,
     MONITOR_OLVD_ROW_SKIPPED_BY_OP},
                             ...
                             counter */
{
  ...
  switch (monitor_id) {
    ...
    /* innodb_rds_rows_skipped_by_offset_pushdown */
    case MONITOR_OLVD_ROW_SKIPPED_BY_OP:
      value = srv_stats.n_rds_rows_skipped_by_offset_pushdown;
      break;
