...
struct row_prebuilt_t {
  ...
  */
  ...
  innodb_session_t *session; /*!< InnoDB session handler. Only for intrinsic
                               table. */
  ...
  /**
     For Parallel Query. Like the 'index' member, but obtained from
     ha_innobase::m_old_share. @see ha_innobase::m_old_share.
  */
